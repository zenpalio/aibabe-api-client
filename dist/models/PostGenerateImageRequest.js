...
exports.instanceOfPostGenerateImageRequest = instanceOfPostGenerateImageRequest;
exports.PostGenerateImageRequestFromJSON = PostGenerateImageRequestFromJSON;
 ...
 */
function instanceOfPostGenerateImageRequest(value) {
...
function PostGenerateImageRequestFromJSON(json) {
    return PostGenerateImageRequestFromJSONTyped(json, false);
}
function PostGenerateImageRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function PostGenerateImageRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
