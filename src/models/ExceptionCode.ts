...
export const ExceptionCode = {
    ...
    EventNotPublishable: 'event_not_publishable',
    EventNotUpdateable: 'event_not_updateable',
    EventApprovalAlreadyPending: 'event_approval_already_pending',
    EventAlreadyEnded: 'event_already_ended',
    EventRatingNotAllowedYet: 'event_rating_not_allowed_yet',
    EventSubmissionsNotAllowed: 'event_submissions_not_allowed',
    EventSubmissionLimitReached: 'event_submission_limit_reached',
    EventInvalidContentType: 'event_invalid_content_type',
    EventContentAlreadySubmited: 'event_content_already_submited',
