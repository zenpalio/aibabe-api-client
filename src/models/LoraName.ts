...
export function instanceOfLoraName(value: any): boolean {
    for (const key in LoraName) {
        if (Object.prototype.hasOwnProperty.call(LoraName, key)) {
            if (LoraName[key as keyof typeof LoraName] === value) {
                return true;
            }
        }
    }
...
export function LoraNameFromJSON(json: any): LoraName {
    return LoraNameFromJSONTyped(json, false);
}

export function LoraNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): LoraName {
    return json as LoraName;
}

export function LoraNameToJSON(value?: LoraName | null): any {
    return value as any;
}

export function LoraNameToJSONTyped(value: any, ignoreDiscriminator: boolean): LoraName {
    return value as LoraName;
}
