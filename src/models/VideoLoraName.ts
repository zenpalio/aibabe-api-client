...
export function instanceOfVideoLoraName(value: any): boolean {
    for (const key in VideoLoraName) {
        if (Object.prototype.hasOwnProperty.call(VideoLoraName, key)) {
            if (VideoLoraName[key as keyof typeof VideoLoraName] === value) {
                return true;
            }
        }
    }
...
export function VideoLoraNameFromJSON(json: any): VideoLoraName {
    return VideoLoraNameFromJSONTyped(json, false);
}

export function VideoLoraNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): VideoLoraName {
    return json as VideoLoraName;
}

export function VideoLoraNameToJSON(value?: VideoLoraName | null): any {
    return value as any;
}

export function VideoLoraNameToJSONTyped(value: any, ignoreDiscriminator: boolean): VideoLoraName {
    return value as VideoLoraName;
}
